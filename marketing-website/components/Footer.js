...
const Footer = () => {
  const footerLinks = {
    ...
    social: [
      { name: 'Twitter', href: 'https://twitter.com/friendsofpifa' },
      { name: 'LinkedIn', href: 'https://linkedin.com/company/friendsofpifa' },
      { name: 'GitHub', href: 'https://github.com/friendsofpifa' },
    ]
  }
