...
const AuctionRoom = ({ tournamentId, user }) => {
  ...
  const advanceToNextTeam = async () => {
    ...
    console.log('Auto-advancing to next team...');
    ...
    try {
      ...
      if (response.data.status === 'completed') {
        ...
        alert('🎉 Auction completed! All players have been assigned.');
        ...
        <div className="container mx-auto px-4 py-6">
          ...
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center space-x-4">
              ...
              <span className="bg-yellow-600 text-white px-3 py-1 rounded-full text-sm font-medium">Tournament</span>
            </div>
            <button
              onClick={() => navigate('/app')}
              className="flex items-center space-x-2 text-gray-400 hover:text-white transition-colors"
        ...
        <div className="container mx-auto px-4 py-6">
          ...
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center space-x-4">
              ...
              <span className="bg-red-600 text-white px-3 py-1 rounded-full text-sm font-medium">Live Auction</span>
            </div>
            <button
